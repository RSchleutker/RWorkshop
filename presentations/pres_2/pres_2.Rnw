...
\subtitle{Part II: Primitive Data Structures and Assignments}
% \date{\today}
...
\begin{frame}[fragile]{Contents of this workshop}
	...
	\begin{enumerate}
		...
		\item How to get help and how to structure your code
		\item Functions 101
		\item Non-primitive data structures and functions
		\item Subsetting
		\item Data input/output
		\item Working with data frames
		\item Graphics I
		\item Control structures
		\item Working with text information
		\item Writing own functions
		\item Graphics II
...
\begin{frame}[fragile]{R as a Calculator}
	...
	In the simplext case, R can be used just as a calculator.
...
\begin{frame}[fragile]{Primitive Data Structures -- Characters}
	...
	Characters are not numeric, even if it consists if digit characters only.
...
\begin{frame}[fragile]{Primitive Data Structures -- How to work with Vectors}
	...
	At the beginning, its hard to get your head around vectors but they turn out to be quite handy.
	...
	When doing math with vectors, shorter vectors are recycled.
